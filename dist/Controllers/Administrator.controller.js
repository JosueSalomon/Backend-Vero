...
const register_payment_and_update_commission = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { url_reciet } = req.body;
    try {
        const Response = yield Administrator_model_1.Administrator.register_payment_and_update_commission(Number(id), url_reciet);
        res.status(200).json({
            Response
        });
    }
