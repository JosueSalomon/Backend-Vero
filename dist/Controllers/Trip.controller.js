...
exports.RateTrips = exports.reportTripUser = exports.cancelTripFromDriver = exports.getTripDetails = void 0;
...
const RateTrips = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { user_Rating_id, calificacion, comment } = req.body;
    try {
        const Response = yield Trip_model_1.Trip.RateTrip(user_Rating_id, calificacion, Number(id), comment);
        res.status(201).json({
            Response
        });
    }
